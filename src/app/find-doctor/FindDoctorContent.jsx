...
const DOCTORS = [
  ...
  { dept: 'Consultants', name: 'Dr. Syed Zafar ul Islam',     qual: 'MBBS, MS Ortho, FIASM',                        specialty: 'Orthopedics',                  exp: '',    img: 'https://res.cloudinary.com/dmhonzqrm/image/upload/v1788179694/Dr_Zafar_obmvfd.jpg', initials: 'SZ', gender: 'male',   filled: true  },
  ...
  { dept: 'Consultants', name: 'Dr. Anil Kumar Malhari',      qual: 'MCh (Plastic & Reconstructive Surgery)',         specialty: 'Plastic Surgery',              exp: '',    img: null,                              initials: 'AM', gender: 'male',   filled: false },
  ...
  { dept: 'Consultants', name: 'Dr. Vishal Hudgi',            qual: 'MBBS, DNB (Vascular & Endovascular Surgery)',   specialty: 'Vascular Surgery',             exp: '',    img: null,                              initials: 'VH', gender: 'male',   filled: false },
