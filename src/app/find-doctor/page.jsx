...
const DOCTORS = [
  ...
  { dept: 'Consultants', name: 'Dr. Zeeshan Ali',             qual: 'MBBS, MD, DM (Gastroenterology)',               specialty: 'Medical Gastroenterology',     exp: '13+', img: '/doctors/Dr zeeshan ali.JPG',     initials: 'ZA', gender: 'male',   filled: true  },
  { dept: 'Consultants', name: 'Dr. Veeresh Godi',            qual: 'MBBS, MD (Internal Medicine)',                  specialty: 'General Medicine',             exp: '3+',  img: '/doctors/Dr veeresh godi.JPG',    initials: 'VG', gender: 'male',   filled: true  },
  { dept: 'Consultants', name: 'Dr. Mahalingam',              qual: 'MBBS, MS Ortho, FMISS',                        specialty: 'Orthopedics & Spine Surgery',  exp: '5+',  img: '/doctors/Dr Mahaligam.JPG',       initials: 'MA', gender: 'male',   filled: true  },
  ...
  { dept: 'Consultants', name: 'Dr. Mohammed Taif Bendigeri', qual: 'MBBS, MS, MCh (Urology)',                       specialty: 'Urology',                      exp: '',    img: null,                              initials: 'TB', gender: 'male',   filled: true  },
  ...
  { dept: 'Consultants', name: 'Dr. Shrutika',                qual: 'MBBS, MS (Obstetrics & Gynaecology)',           specialty: 'Gynecology',                   exp: '',    img: null,                              initials: 'SR', gender: 'female', filled: true  },
  ...
  { dept: 'Emergency Department', name: 'Dr. Udaykumar Khasage',  qual: 'MBBS, MD, DNB (Emergency Medicine)', specialty: 'Emergency Medicine', exp: '', img: null, initials: 'UK', gender: 'male', filled: false, badge: 'Head of Department' },
...
function DoctorCard({ name, qual, specialty, exp, img, initials, gender, filled, badge, t }) {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-4 hover:shadow-lg hover:-translate-y-1 transition-all flex flex-col justify-between">
      <div className="flex gap-4 mb-5">
        ...
        <div className="min-w-0">
          {badge && (
            <span className="inline-block text-[9px] font-bold uppercase tracking-wider bg-amber-50 text-amber-600 border border-amber-100 px-2 py-0.5 rounded-full mb-1.5">{badge}</span>
          )}
