        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-6 border-b border-white/5 pb-6">
          ...
          <div>
            ...
            <div className="space-y-2 text-xs text-gray-400 border-t border-white/5 pt-3">
              ...
              <a href="https://wa.me/919353957095" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-white active:text-white/80 transition-colors">
